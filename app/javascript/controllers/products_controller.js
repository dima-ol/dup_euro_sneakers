...
export default class extends Controller {
  ...
  addToCart() {
    ...
    // Dispatch a global toast event so the toast controller can show a notification
    const name = this.productValue.name || 'Товар'
    window.dispatchEvent(new CustomEvent('toast', { detail: { message: `${name} додано до кошика` } }))
  }
